...
export const flirty = [
  {
    text: "Take 3 sips if you have ever been to a different country",
    category: "RULE",
  },
  {
    text: "Down your drink if you have a tattoo",
    category: "GET IT DOWN YA",
  },
  {
    text: "[Name] take 2 sips if you have ever ridden a rollercoaster, otherwise give them out",
    category: "RULE",
  },
  {
  ...
  {
    text: "[Name] down your drink if you have ever played a sport at a professional level, otherwise give it out",
    category: "RULE",
  },
  {
  ...
  {
    text: "[Name] take 3 sips if you have a job in finance, otherwise give them out",
    category: "RULE",
  },
  {
  ...
  {
    text: "Types of Fruit, the first to repeat themselves or can't think of any more must drink 3 times. [Name] you start",
    category: "CHALLENGE",
  },
  {
  ...
  {
    text: "Bands from the 90s, the first to repeat themselves or can't think of any more must drink 5 times. [Name] you start",
    category: "CHALLENGE",
  },
  {
    text: "Sports Teams, the first to repeat themselves or can't think of any more must drink 2 times. [Name] you start",
    category: "CHALLENGE",
  },
  {
  ...
  {
    text: "Musical Artists, the first to repeat themselves or can't think of any more must drink 4 times. [Name] you start",
    category: "CHALLENGE",
  },
  {
    text: "Movies, the first to repeat themselves or can't think of any more must drink 3 times. [Name] you start",
    category: "CHALLENGE",
  },
  {
  ...
  {
    text: "You get to have 5 minutes of sex before you die with whomever and wherever you want. [Name] and [Name2] suggest a choice, then the other players vote for the most relevant one! The winner gives out 2 sips, the loser drinks twice.",
    category: "VOTE",
  },
  {
  ...
  {
    text: "Let's play one spin the bottle round! Every player spin the bottle and kiss the targeted player. 2 sips for each refusal, [Name] starts",
    category: "CHALLENGE",
  },
  {
  ...
  {
    text: "[Name] decides: either [Name2] gives out 2 sips or [Name3] gives out 2 sips",
    category: "SEXY",
  },
  {
  ...
  {
    text: "Male boxers contest! Girls you're the jury, loser gets 3 sips",
    category: "SEXY",
  },
  {
    text: "“Places to put your hands during penetration”, the first to run out of ideas drink 4 times. [Name], you start",
    category: "CHALLENGE",
  },
  {
    text: "Go around the room and choose someone who'll have to touch your crotch. 4 sips for each refusal, [Name] you start",
    category: "CHALLENGE",
  },
  {
  ...
  {
    text: "[Name] ask a question to the room at large. The first person to answer can give out 5 sips",
    category: "CHALLENGE",
  },
  {
    text: "Go around the room, do a gesture after repeating the gestures done so far. The loser drinks 2 times! [Name] you start",
    category: "CHALLENGE",
  },
  {
  ...
  {
    text: "[Name], lick someone's nipples. 3 sips in case of refusal ",
    category: "SEXY",
  },
  {
    text: "[Name], give a French kiss to [Name2] or drink 2 times",
    category: "SEXY",
  },
  {
    text: "[Name], lick someone's lips. 5 sips in case of refusal",
    category: "SEXY",
  },
  {
  ...
  {
    text: "If you've had sex while you or your partner were on their period, drink 4 times",
    category: "RULE",
  },
  {
  ...
  {
    text: "Drink 2 times if you've given a blowjob this week",
    category: "RULE",
  },
  {
    text: "The last person to have performed passionate cunnilingus, gives out 3 sips",
    category: "RULE",
  },
  {
    text: "Drink 5 times if you've ever used objects while having sex",
    category: "RULE",
  },
  {
  ...
  {
    text: "Drink 3 times if you've ever had an object in your anus or vagina",
    category: "RULE",
  },
  {
    text: "Drink 3 times if you've ever watched people having sex",
    category: "RULE",
  },
  {
    text: "The last person to have performed a nice blowjob, gives out 2 sips",
    category: "RULE",
  },
  {
  ...
  {
    text: "If you like dirty talk, drink 2 times",
    category: "RULE",
  },
  {
